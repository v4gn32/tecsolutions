                ...
                {item.path === '/proposals' ? (
                  <button
                    ...
                    className={`w-full flex items-center px-6 py-3 text-sm font-medium transition-colors duration-200 ${
                      isActive
                        ? 'bg-cyan-50 text-cyan-600 relative before:absolute before:right-0 before:top-0 before:bottom-0 before:w-1 before:bg-cyan-600'
                    ...
                    <Link
                      ...
                      className={`flex items-center px-12 py-2 text-sm font-medium transition-colors duration-200 ${
                        location.pathname === '/proposals/new'
                          ? 'text-cyan-600 bg-cyan-50 relative before:absolute before:right-0 before:top-0 before:bottom-0 before:w-1 before:bg-cyan-600'
